...
const Hero = () => {
  ...
  return (
    // Main Container 
    <section className='relative w-full h-screen mx-auto hero-section bg-cover bg-no-repeat bg-center'>
      <div className={`${styles.padding} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-center gap-5`}>
